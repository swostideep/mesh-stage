...
// Reads STEP/IGES, heals the topology, meshes every face and welds the result
// into a single indexed surface mesh. Returns false when the file cannot be
// read or contains no usable faces.
